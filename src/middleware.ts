...
export async function middleware(request: NextRequest) {
  ...
  const securityHeaders = {
    "Content-Security-Policy": [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co https://app.posthog.com https://*.posthog.com https://accounts.google.com https://oauth2.googleapis.com https://www.googleapis.com",
