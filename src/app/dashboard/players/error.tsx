...
/**
 * Error boundary for the dashboard players view.
 */
export default function PlayersError({
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center text-center">
      ...
      <h2 className="mb-1 text-lg font-semibold">Couldn&apos;t load players</h2>
      <p className="mb-4 max-w-sm text-sm text-muted-foreground">
        Something went wrong loading your players. Please try again, or go
